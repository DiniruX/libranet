    ...
    <div :class="`modal ${!open && 'opacity-0 pointer-events-none'} z-50 fixed w-full h-full top-0 left-0 flex items-center justify-center`">
      ...
      <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white rounded shadow-lg modal-container md:max-w-md">
        ...
        <div class="px-6 py-4 text-left modal-content">
          ...
          <!--Body-->
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente asperiores sint necessitatibus aspernatur laborum quod ad quibusdam
            voluptate aliquid molestiae! Cumque voluptatem sint eum, quibusdam cupiditate vero quis. Praesentium, et!
          </p>
