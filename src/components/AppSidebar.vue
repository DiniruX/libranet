    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <svg class="w-8 h-8 ml-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <span class="mx-2 text-2xl font-semibold text-white">LibraNet</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          ...
          :class="[$route.name === 'Books' ? activeClass : inactiveClass]"
          to="/books"
        >
          ...
          <span class="mx-4">Books</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Libraries' ? activeClass : inactiveClass]"
          to="/libraries"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <span class="mx-4">Libraries</span>
        </router-link>
        ...
        >
          ...
          <span class="mx-4">Reservations</span>
        </router-link>

        <router-link
          v-if="role === 'admin' || role === 'librarian'"
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
